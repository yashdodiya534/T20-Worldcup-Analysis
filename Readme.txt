Now Let's understand the project step by step.
...
what I learned from the overall project:
1)How to collect data from any website using web scraping.
2)How to clean data in python pandas.
3)what are key points while designing your dashboards, like Dashboard Theme color, primary and secondary color, Font selection & size, and Aspect ratio for images.
